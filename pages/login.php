<div class="card text-light">
    ...
    <div class="card-img-overlay mt-5">
        ...
        <h2 class="card-title d-flex justify-content-center font-weight-bold text-xl-left">LOGIN</h2>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-4"></div>
            <div class="col-4  border border-secondary p-3">
                <h3 class="text-secondary" style="margin-left: 5em;">Login</h3>
                <form action="models/login_model.php" method="post">
                    ...
                    <div class="form-group">
                        <button class="btn btn-secondary btn-block" type="submit">Login now </button>
                    </div>
                </form>
            <hr>
